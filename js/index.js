...
<div class="item position-relative overflow-hidden">
    ...
    document.getElementById("categoriesRow").innerHTML = container;
...
document.getElementById("area").addEventListener("click",async function(){
        ...
        for (let i = 0; i < areas.length; i++) {
            container+=`<div class="col-md-3 areaBox" id="${areas[i].strArea}">
            <div><i class="fa-solid fa-house-laptop fa-4x"></i></div>
            <h3>${areas[i].strArea}</h3>
    </div>`
        }
        document.getElementById("areaRow").innerHTML=container
        displayAreaMeals()
        hideLoader()
    })
...
document.getElementById("ingredients").addEventListener("click",async function(){
    ...
    let container=''
    for (let i = 0; i <25; i++) {
        container+=`<div class="col-md-3 myIngredient" id="${ingredients[i].strIngredient}">
    ...
    document.getElementById("ingredientsRow").innerHTML=container
